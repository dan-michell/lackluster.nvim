...
return function(color, color_special)
    ...
    result.ui = {
        ...
        bg_cursorline = color_special.custom_background, -- color.gray2,
    ...
    result.syntax_default = {
        ...
        builtin = color.gray5,
        keyword = color_special.custom_yellow,
        keyword_return = color_special.custom_yellow,
        keyword_exception = color_special.custom_yellow,
        string = color_special.custom_green,
        string_escape = color_special.custom_green,
